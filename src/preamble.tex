...
\setmonofont{DejaVuSansMono}                              %  to turn out curly
                                                       %  ("typographic")
...
\usepackage[papersize={148mm,197mm},
            top=10mm,
            textwidth=130mm,  % increase one or both of these by 1mm or so to
            textheight=170mm, % make the source compile with TeX Live 2013
